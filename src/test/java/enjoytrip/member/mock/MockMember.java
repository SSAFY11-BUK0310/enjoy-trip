...
public class MockMember extends Member {
    ...
    public MockMember(Long id, String email, String password, String name, Integer age, Gender gender, String phoneNumber, LocalDateTime createAt, LocalDateTime updatedAt, String createdBy, String updatedBy) {
        super(id, email, password, name, age, gender, phoneNumber, createAt, updatedAt, createdBy, updatedBy);
    }
